...
public class DrugSAXParser<T> implements DrugParser {

    private Builder<T> builder;

    public DrugSAXParser(Builder<T> builder) {
        this.builder = builder;
    }

    @Override
    public Object parseMedicine(String path) {
        ...
        try {
            ...
            Logger.getLogger(DrugSAXParser.class.getName()).log(Level.INFO, "Got an exception");
        }
